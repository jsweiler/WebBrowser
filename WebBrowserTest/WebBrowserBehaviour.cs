...
namespace WebBrowserTest
{
    public class WebBrowserBehavior
    {
        ...
        {
            var browser1 = d as WebBrowser;
            if (browser1 == null) return;
            if (Equals(e.OldValue, e.NewValue)) return;
            var uri = e.NewValue as string;
            browser1.Navigate(new Uri(uri));
        }
        ...
        private class SilentJavascriptErrorsContext : IDisposable
        {
            ...
            private void SetSilent()
            {
                ...
                //dynamic activeX = this._webBrowser.GetType().InvokeMember("ActiveXInstance",
                //    BindingFlags.GetProperty | BindingFlags.Instance | BindingFlags.NonPublic,
                //    null, this._webBrowser, new object[] { });
                //if (activeX != null)
                //    activeX.Silent = true;
            }
